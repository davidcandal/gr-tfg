...
# Title: Nwk3
# Generated: Fri Sep  2 16:20:35 2016
##################################################
...
class nwk3(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Nwk3")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Nwk3")
        try:
        ...
        self.settings = Qt.QSettings("GNU Radio", "nwk3")
        ...
        self.msg_connect((self.tfg_test_nwk_0, 'salida'), (self.tfg_NWK_stack_constructor_0, 'in(APS)'))    
...
def main(top_block_cls=nwk3, options=None):
