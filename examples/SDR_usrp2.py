...
# Generated: Mon Sep 26 13:09:57 2016
##################################################
...
class SDR_usrp2(gr.top_block, Qt.QWidget):

    def __init__(self, miusrp, num):
        ...
        self.settings = Qt.QSettings("GNU Radio", "SDR_usrp2")
        ...
        self.MAC_modoSrc = MAC_modoSrc = 0
        self.MAC_modoDest = MAC_modoDest = 0
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, '/tmp/sdr' + num + '.pcap', False)
...
def main(usrp, num, top_block_cls=SDR_usrp2, options=None):
