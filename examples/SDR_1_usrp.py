...
# Generated: Thu Sep 22 16:27:10 2016
##################################################
...
class SDR_1_usrp(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "SDR_1_usrp")
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, '/tmp/sensor1.pcap', False)
...
def main(top_block_cls=SDR_1_usrp, options=None):
