...
# Generated: Thu Sep 22 16:42:50 2016
##################################################
...
class SDR_2_usrp(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "SDR_2_usrp")
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, '/tmp/sensor2.pcap', False)
...
def main(top_block_cls=SDR_2_usrp, options=None):
