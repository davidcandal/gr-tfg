...
# Generated: Sat Oct 15 23:07:57 2016
##################################################
...
class SDR_usrp(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, miusrp):
        ...
        self.tfg_motecontrol_0 = tfg.motecontrol()
        ...
        self.blocks_message_strobe_0 = blocks.message_strobe(pmt.intern("TEST"), 4265)
        ...
        # Connections
        ##################################################
        self.msg_connect((self.blocks_message_strobe_0, 'strobe'), (self.tfg_motecontrol_0, 'beacon'))    
        ...
        self.msg_connect((self.tfg_MAC_stack_0, 'out(NWK)'), (self.tfg_motecontrol_0, 'in'))    
        ...
        self.msg_connect((self.tfg_motecontrol_0, 'out'), (self.tfg_MAC_stack_0, 'in(NWK)'))    
