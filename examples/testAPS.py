...
# Generated: Mon Sep 19 23:03:24 2016
##################################################
...
class testAPS(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "testAPS")
        ...
        self.tfg_NWK_stack_0 = tfg.NWK_stack(False, False)
        self.tfg_MAC_stack_0 = tfg.MAC_stack(False, False)
        self.tfg_APS_stack_0 = tfg.APS_stack(True, True)
...
def main(top_block_cls=testAPS, options=None):
